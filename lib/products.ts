...
export const productCategories: ProductCategory[] = [
  ...
  { slug: "oksidan", name: "Oksidan", description: "Kuaf Professional markalı, profesyonel saç işlemleri için oksidanlar.", products: [
    item("kuaf-professional-10-vol-5l", "10 Vol 5L", "Kuaf Professional"),
    item("kuaf-professional-20-vol-5l", "20 Vol 5L", "Kuaf Professional"),
    item("kuaf-professional-30-vol-5l", "30 Vol 5L", "Kuaf Professional"),
    item("kuaf-professional-40-vol-5l", "40 Vol 5L", "Kuaf Professional"),
  ] },
